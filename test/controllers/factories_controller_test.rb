...
class FactoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create factory" do
    assert_difference("Factory.count") do
      post factories_url, params: { factory: { description: @factory.description, name: @factory.name, url: @factory.url } }
    end
  ...
  test "should update factory" do
    patch factory_url(@factory), params: { factory: { description: @factory.description, name: @factory.name, url: @factory.url } }
